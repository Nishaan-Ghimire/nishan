    ...
    return (
        <main name="home" className="w-full flex lg:flex-row flex-col gap-[2rem] justify-between lg:p-0 md:p-[1rem] p-[4px] " >
            ...
            <div className={` flex-col lg:w-[39rem] w-full lg:items-start items-center justify-start pt-32 gap-[1.5rem] text-white  `} >
                ...
                <h1 className="md:text-[5.5rem] text-[50px] font-extrabold w-full leading-[1.1em] lg:text-start text-center text-white "  >
                    I'm <span className="text-orange " >Nishan Ghimire</span>
                </h1>
                <h2 className="lg:text-[35px] text-[25px] font-medium lg:text-start tracking-[3px] text-center text-white " >
                    Independent Security Researcher | Developer | AWS Cloud Practitioner
                </h2>
